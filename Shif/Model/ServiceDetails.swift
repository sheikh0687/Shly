...
struct Api_RequestDetail : Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent(Res_RequestDt.self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct Res_RequestDt : Codable {
    let id : String?
    let user_id : String?
    ...
    let provider_details : Service_Provider_details?
    let user_details : Service_User_details?
    let request_images : [String]?
    let service_details : [Sub_Service_details]?
    let extra_service_list : [Extra_service_list]?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case extra_service_list = "extra_service_list"
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        provider_details = try values.decodeIfPresent(Service_Provider_details.self, forKey: .provider_details)
        user_details = try values.decodeIfPresent(Service_User_details.self, forKey: .user_details)
        request_images = try values.decodeIfPresent([String].self, forKey: .request_images)
        service_details = try values.decodeIfPresent([Sub_Service_details].self, forKey: .service_details)
        extra_service_list = try values.decodeIfPresent([Extra_service_list].self, forKey: .extra_service_list)
    }
}

struct Service_Provider_details : Codable {
    let id : String?
    let store_id : String?
...
struct Service_User_details : Codable {
    let id : String?
    let store_id : String?
    let first_name : String?
    let last_name : String?
...
struct Sub_Service_details : Codable {
    let id : String?
    let user_id : String?
    let cat_id : String?
    let cat_name : String?
    ...
    let date_time : String?
    let remove_status : String?
    let service_images : [Service_images]?
    ...
    init(from decoder: Decoder) throws {
        ...
        date_time = try values.decodeIfPresent(String.self, forKey: .date_time)
        remove_status = try values.decodeIfPresent(String.self, forKey: .remove_status)
        service_images = try values.decodeIfPresent([Service_images].self, forKey: .service_images)
    }

}

struct Extra_service_list : Codable {
    let id : String?
    ...
    let service_id : String?
    let service_payment_type : String?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case service_id = "service_id"
        case service_payment_type = "service_payment_type"
    ...
    init(from decoder: Decoder) throws {
        ...
        service_id = try values.decodeIfPresent(String.self, forKey: .service_id)
        service_payment_type = try values.decodeIfPresent(String.self, forKey: .service_payment_type)
