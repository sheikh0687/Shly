...
struct Res_Profile : Codable {
    ...
    let cash : String?
    let paypal : String?
    let total_service_count : String?
    let noti_count : String?
    let store_set_time : String?
    let total_cart : String?
    let cart_cat_id : String?
    let provider_images : [Provider_images]?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case cash = "cash"
        case paypal = "paypal"
        case total_service_count = "total_service_count"
        case noti_count = "noti_count"
        case store_set_time = "store_set_time"
        case total_cart = "total_cart"
        case cart_cat_id = "cart_cat_id"
    ...
    init(from decoder: Decoder) throws {
        ...
        total_service_count = try values.decodeIfPresent(String.self, forKey: .total_service_count)
        noti_count = try values.decodeIfPresent(String.self, forKey: .noti_count)
        store_set_time = try values.decodeIfPresent(String.self, forKey: .store_set_time)
        total_cart = try values.decodeIfPresent(String.self, forKey: .total_cart)
        cart_cat_id = try values.decodeIfPresent(String.self, forKey: .cart_cat_id)
        provider_images = try values.decodeIfPresent([Provider_images].self, forKey: .provider_images)
    }

}

struct Provider_images : Codable {
    let id : String?
    let user_id : String?
    let image : String?
    let date_time : String?
