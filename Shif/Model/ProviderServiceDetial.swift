...
struct Api_ProviderServiceDt : Codable {
    let result : Res_ProviderServiceDt?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent(Res_ProviderServiceDt.self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct Res_ProviderServiceDt : Codable {
    let id : String?
    let user_id : String?
    let cat_id : String?
    let cat_name : String?
    ...
    let service_images : [Provider_Service_images_Dt]?
    ...
    init(from decoder: Decoder) throws {
        ...
        service_images = try values.decodeIfPresent([Provider_Service_images_Dt].self, forKey: .service_images)
    }

}

struct Provider_Service_images_Dt : Codable {
    let id : String?
