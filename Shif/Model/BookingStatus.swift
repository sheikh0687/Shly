...
struct Res_BookingStatus : Codable {
    ...
    let total_amount_with_admin_service : String?
    let total_admin_service_fee : String?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case total_amount_with_admin_service = "total_amount_with_admin_service"
        case total_admin_service_fee = "total_admin_service_fee"
    ...
    init(from decoder: Decoder) throws {
        ...
        total_amount_with_admin_service = try values.decodeIfPresent(String.self, forKey: .total_amount_with_admin_service)
        total_admin_service_fee = try values.decodeIfPresent(String.self, forKey: .total_admin_service_fee)
        provider_details = try values.decodeIfPresent(Provider_details.self, forKey: .provider_details)
        service_details = try values.decodeIfPresent([Service_details].self, forKey: .service_details)
...
struct Service_details : Codable {
    let id : String?
    let user_id : String?
    let cat_id : String?
    let cat_name : String?
    ...
    let date_time : String?
    let remove_status : String?
    let service_images : [Service_images_Status]?
    ...
    init(from decoder: Decoder) throws {
        ...
        date_time = try values.decodeIfPresent(String.self, forKey: .date_time)
        remove_status = try values.decodeIfPresent(String.self, forKey: .remove_status)
        service_images = try values.decodeIfPresent([Service_images_Status].self, forKey: .service_images)
    }
}

struct Service_images_Status : Codable {
    let id : String?
    let service_id : String?
    let image : String?
    let date_time : String?
