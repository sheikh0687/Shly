...
struct Api_ChangePassword : Codable {
    let result : Res_ChangePassword?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent(Res_ChangePassword.self, forKey: .result)
...
struct Res_ChangePassword : Codable {
    let id : String?
