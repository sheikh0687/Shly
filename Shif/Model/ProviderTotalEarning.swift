//
//  ProviderTotalEarning.swift
//  Shif
//
//  Created by Techimmense Software Solutions on 31/10/23.
//

import Foundation

struct Api_ProviderTotalEarning : Codable {
    let total_earning : String?
    let wallet_balence : String?
    let total_earning_today : String?
    let result : [Res_ProviderTotalEarning]?
    let message : String?
    let status : String?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case wallet_balence = "wallet_balence"
    ...
    init(from decoder: Decoder) throws {
        ...
        wallet_balence = try values.decodeIfPresent(String.self, forKey: .wallet_balence)
        total_earning_today = try values.decodeIfPresent(String.self, forKey: .total_earning_today)
        result = try values.decodeIfPresent([Res_ProviderTotalEarning].self, forKey: .result)
...
struct Res_ProviderTotalEarning : Codable {
    let id : String?
    let user_id : String?
